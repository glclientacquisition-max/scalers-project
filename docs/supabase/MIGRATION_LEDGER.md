...
| LEDGER-REALTIME-INBOX | `supabase_realtime` publication += `calls`, `service_requests`, `appointments` | Live Inbox desk updates | `realtime_inbox.sql` | this PR | YES (2026-09-16) | NO | NO | `pg_publication_tables` membership check; desk subscription smoke |
