...
| Human handoff (live) | Conference hold + outbound REST | Gated (`VOICE_LIVE_TRANSFER`) | [`../LIVE_TRANSFER.md`](../LIVE_TRANSFER.md), ADR-0004 | Closing Stream before originate | PROPOSED |
