...
**First-open introduction:** Brand-first English greeting via `src/conversation/businessAssistantIntro.js` (business name → agent name → help invite). Do not lottery-open in Kiswahili; match language after the caller speaks.
