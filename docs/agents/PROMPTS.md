...
Apply the platform design mandate on every change: zero fluff copy, no em/en dashes in UI text, dense tables over stacked cards, split-pane details, filled primary CTA `#005CCC` (white label), ribbon/focus/tab underline `#0096FF`, sticky Save top-right, muted secondary actions.
