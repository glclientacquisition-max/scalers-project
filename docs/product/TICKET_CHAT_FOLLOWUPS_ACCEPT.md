...
3. AI-generic chrome still shows: “FAQ ideas” / “Find FAQ ideas”, disabled “Polish” on SMS dock — sparkle / Ask AI noise without a shipped job.
...
3. **Remove AI-generic chrome on ticket:** drop “FAQ ideas” / “Find FAQ ideas”, disabled “Polish” on SMS dock, and any Ask AI / sparkle / “How can I help” beyond those on this surface. Do not invent a replacement AI feature.  
4. Dock (Mark done · WhatsApp · Call · Ping / Confirm·Hold Done) stays. Contact strip (#383) stays. Honesty chips unchanged (Critic if copy moves).  
...
Open ticket on ~390 → no full bottom tab bar → no em dash in ticket copy → no FAQ ideas / Polish / sparkle → dock still works → tablet/desktop still usable.
