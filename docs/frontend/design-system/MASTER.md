...
| Filter tabs | `FilterTabs` + `filterTabClass`. Underline, `min-h-11`, active `border-[#0096FF] text-[#005CCC]`. Inbox List/Work and Today/Week share this with Contacts. Contacts segments: All · Saved · Unsaved only. Sort: Last call · Name. Inbox purpose piles (Needs you / Visits / Holds / …) stay `InboxFilterPills`. |
