...
- Inbox → Visits (`/calls?purpose=job`). One book: requested and confirmed visits. List is newest work. Work holds Today (run sheet by clock) and Week (by day; phone days with work, desktop seven-day grid). Timed holds stay on Holds. No extra nav item.
