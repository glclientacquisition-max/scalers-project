...
- Inbox → Visits (`/calls?purpose=job`). List is requested and confirmed, newest first, with last week's still-open confirmed visits pinned at the top. Work is confirmed only (Today by clock, Week by day; phone days with work, desktop seven-day grid). Timed holds stay on Holds List or Holds Work (Today). No extra nav item.
