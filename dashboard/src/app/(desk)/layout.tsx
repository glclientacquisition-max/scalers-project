...
import { DeskMobileNav, DeskNav } from "@/components/DeskNav";
 ...
 * Structure: sticky header (brand + desktop nav) → content → mobile bottom nav.
 */
export default async function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen min-w-0">
      ...
      <main className="mx-auto w-full min-w-0 max-w-desk px-4 py-6 pb-[calc(1.5rem+var(--desk-bottom-nav-h,0px))] sm:px-6 sm:pt-10 sm:pb-[calc(2.5rem+var(--desk-bottom-nav-h,0px))]">
        {children}
      </main>
      <DeskMobileNav />
    </div>
