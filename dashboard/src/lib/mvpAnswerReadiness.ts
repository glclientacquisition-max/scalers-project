  ...
  const items: MvpReadinessItem[] = [
    {
      ...
      hint: "Assign a DID from the pool before callers can reach your assistant.",
    },
    {
      id: "prompt",
      ...
      hint: "Finish onboarding or save in Business.",
    },
    {
      id: "identity",
      label: "Assistant name and tone",
      required: true,
    ...
    },
    {
      ...
      hint: "Use Mon to Sat, 9:00 AM to 7:00 PM style text so open and closed is automatic.",
    },
    {
      id: "location",
    ...
    },
    {
      ...
      hint: retail
        ? "Upload titles in Train for price, hold, and order. Blank prices are OK."
