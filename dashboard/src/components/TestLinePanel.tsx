    ...
    <div className="mx-auto max-w-xl space-y-6">
      ...
      <section className="space-y-3 border-t border-[var(--line)] pt-8" aria-labelledby="test-call-heading">
        ...
        {pendingDid || !did ? (
          ...
          <a
            href={`tel:${did}`}
            className="flex min-h-14 w-full items-center justify-center rounded-2xl border border-[var(--line)] bg-surface px-4 py-4 text-center font-display text-[clamp(1.15rem,4vw,1.5rem)] tracking-tight text-[var(--ink)] transition hover:border-[var(--accent)]"
          >
            {did}
          </a>
        )}
