  ...
  return (
    <span className="inline-flex items-center gap-2">
      ...
      <a
        ...
        title={`Chat with ${number} on WhatsApp`}
        aria-label={`Chat with ${number} on WhatsApp`}
        className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-whatsapp text-white transition hover:brightness-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0096FF]"
      >
