...
export const settingsSectionClass = "space-y-3 border-t border-line pt-6";

export const settingsStickyHeaderClass =
  "sticky top-0 z-20 -mx-4 mb-8 flex flex-wrap items-center justify-between gap-4 border-b border-line bg-surface-canvas/95 px-4 py-4 backdrop-blur-sm sm:-mx-6 sm:px-6";
...
export function settingsChipClass(selected: boolean) {
  return [
    ...
    selected
      ...
      : "border-line text-ink-soft hover:border-[#0096FF]/40",
  ].join(" ");
}
