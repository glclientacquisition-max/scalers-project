...
function buildLiveGroundTruth(profile = {}) {
  ...
  parts.push(
    ...
    team.length
      ? 'If a caller is angry, asks for a refund/billing, or matches a role above, acknowledge and say that teammate will follow up. Capture name + reason. Do not invent live transfers.'
      : ''
  );
